...
public class GrpcServerProperties {
     ...
     */
    private final net.devh.boot.grpc.server.config.GrpcServerProperties.Security security = new net.devh.boot.grpc.server.config.GrpcServerProperties.Security();
